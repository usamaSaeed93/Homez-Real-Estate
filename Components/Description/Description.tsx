  ...
  return (
    <div className="flex flex-row  m-auto justify-evenly items-start max-w-[1200px] my-5">
      <div className="w-1/2 mt-auto">
        ...
        <p className="text-2xl text-black opacity-50 pt-6">Description</p>
        <p className="max-w-full pr-4 text-start text-sm text-normal">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Officiis
          molestiae cupiditate cum corrupti et, dolores dolore voluptas rem
          officia optio culpa sunt fugiat debitis tenetur doloremque adipisci
          assumenda excepturi illo!
        </p>
